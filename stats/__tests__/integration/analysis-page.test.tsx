...
vi.mock('@/components/analysis/layouts/AnalysisLayout', () => ({
  AnalysisLayout: ({ children }: { children: React.ReactNode }) => (
    <div data-testid="analysis-layout">{children}</div>
  )
}))

vi.mock('@/components/analysis/steps/DataExplorationStep', () => ({
  DataExplorationStep: () => <div data-testid="data-exploration-step">Exploration</div>
}))

vi.mock('@/components/analysis/steps/PurposeInputStep', () => ({
  PurposeInputStep: () => <div data-testid="purpose-input-step">Purpose</div>
}))

vi.mock('@/components/analysis/steps/VariableSelectionStep', () => ({
  VariableSelectionStep: () => <div data-testid="variable-selection-step">Variable</div>
}))

vi.mock('@/components/analysis/steps/AnalysisExecutionStep', () => ({
  AnalysisExecutionStep: () => <div data-testid="analysis-execution-step">Analysis</div>
}))

vi.mock('@/components/analysis/steps/ResultsActionStep', () => ({
  ResultsActionStep: () => <div data-testid="results-action-step">Results</div>
}))

vi.mock('@/components/analysis/AnalysisHistoryPanel', () => ({
  AnalysisHistoryPanel: () => <div data-testid="history-panel">History</div>
}))

vi.mock('@/components/analysis/ReanalysisPanel', () => ({
  ReanalysisPanel: () => <div data-testid="reanalysis-panel">Reanalysis</div>
}))

vi.mock('@/components/analysis/ChatCentricHub', () => ({
