...
vi.mock('@/hooks/use-terminology', () => ({
    useTerminology: () => ({
        ...
        methodSelector: {
            ...
            numericVarsCount: (n: number) => `수치형 변수: ${n}개`,
            categoricalVarsCount: (n: number) => `범주형 변수: ${n}개`,
            assumptions: { normality: '정규성', homogeneity: '등분산성', needsTest: '검정 필요', met: '충족', notMet: '불충족' },
            recommendedBadge: '추천',
            requirementNotMet: '요구사항 미충족',
            showBrief: '간략히 보기',
            showDetails: '자세히 보기',
            searchPlaceholder: '통계 방법 검색...',
            methodCount: (n: number) => `${n}개 방법`,
            searchPrefix: '검색: ',
            selected: '선택됨: ',
            aiRecommended: (n: number) => `AI 추천 (${n})`,
            otherMethods: (n: number) => `기타 방법 (${n})`,
            noSearchResults: (q: string) => `"${q}"에 해당하는 방법이 없습니다`,
            clearSearch: '검색 초기화',
        },
    }),
...
import { MethodSelector } from '@/components/analysis/steps/purpose/MethodSelector'
