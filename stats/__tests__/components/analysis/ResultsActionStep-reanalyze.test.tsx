  ...
  useTerminology: () => ({
    ...
    results: {
      ...
      buttons: {
        ...
        exportHtml: 'HTML', exportR: 'R Script (.R)', exportPython: 'Python (.py)', exportWithOptions: '옵션으로 내보내기', backToVariables: '변수 선택으로',
      },
      save: {
...
describe('ResultsActionStep - 재분석 로직 (Store-level)', () => {
  ...
  it('"다른 데이터로 재분석" 시 stepTrack이 reanalysis가 된다', () => {
    simulateReanalyze()
