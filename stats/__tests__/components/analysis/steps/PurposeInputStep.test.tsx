...
vi.mock('@/components/analysis/steps/purpose/SubcategorySelector', () => ({
    SubcategorySelector: () => <div data-testid="subcategory-selector">Subcategories</div>
}))

vi.mock('@/components/analysis/steps/purpose/GuidedQuestions', () => ({
    GuidedQuestions: () => <div data-testid="guided-questions">Questions</div>
}))

vi.mock('@/components/analysis/steps/purpose/RecommendationResult', () => ({
