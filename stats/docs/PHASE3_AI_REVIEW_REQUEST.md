...
```bash
# 확인할 파일 경로
stats/components/statistics/common/StatisticsTable.tsx
stats/components/statistics/common/EffectSizeCard.tsx
stats/components/statistics/common/StatisticalResultCard.tsx
```
...
2. TypeScript 컴파일: `cd stats && npx tsc --noEmit`
