...
3. ✅ **GOLDEN_SNAPSHOT_STATUS.md**: 43개 × 3 = 129개 목표로 수정
4. ✅ **CLAUDE.md**: 테스트 자동화 철학 섹션 추가 (4가지 규칙)

**v2.1 숫자 정확성 수정 (2025-11-24)**:
1. ✅ **실제 검증**: 페이지 43개 / title 블록 44개 (power-analysis가 3가지)
2. ✅ **문서 통일**: STATUS.md, COVERAGE.md, GOLDEN_SNAPSHOT_STATUS.md 모두 43/44로 수정
3. ✅ **Task Guide**: PHASE_1C (40개 → 30개 남음), DISCRIMINATED_UNION (43개) 수정
4. ✅ **명확성 개선**: "43개 페이지 기준 100%, title 44개 존재" 한 줄 요약 추가

**v2.2 검증 수준 명시 (2025-11-24)**:
1. ✅ **Additional 스키마**: fallback 제거 (v2.0) + passthrough 유지 (유연성)
2. ✅ **스냅샷 상태**: 활성(9개) vs 비활성(47개, skip) 구분 명시
3. ✅ **CI/CD 영향**: 비활성 테스트는 현재 실행 안 됨 문서화
