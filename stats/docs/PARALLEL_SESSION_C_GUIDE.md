...
repeated-measures-anova, response-surface, runs-test, seasonal-decompose,
sign-test, stationarity-test, stepwise, welch-t, wilcoxon, dose-response
```
...
| response-surface | ✅ | ⬜ | ⬜ | ✅ |
| runs-test | ⬜ | ⬜ | ⬜ | ✅ |
| seasonal-decompose | ⬜ | ⬜ | ⬜ | ✅ (예외 후보) |
| sign-test | ✅ | ⬜ | ⬜ | ✅ |
| stationarity-test | ⬜ | ⬜ | ⬜ | ✅ (예외 후보) |
| stepwise | ✅ | ✅ | ⬜ | ✅ |
| welch-t | ✅ | ✅ | ✅ | ✅ |
| wilcoxon | ⬜ | ✅ | ⬜ | ✅ |
| dose-response | ✅ | ⬜ | ✅ | ✅ |
...
- `seasonal-decompose`: 시계열 특수 구조
- `stationarity-test`: 시계열 특수 구조

→ ResultInterpretation만 적용, 나머지는 현상 유지 가능
...
- [ ] response-surface
- [ ] runs-test
- [ ] seasonal-decompose (예외)
- [ ] sign-test
- [ ] stationarity-test (예외)
- [ ] stepwise
- [ ] welch-t
- [ ] wilcoxon
- [ ] dose-response
...
```bash
# 페이지별로 개별 커밋
git add app/(dashboard)/statistics/welch-t/
git commit -m "refactor(welch-t): 공통 컴포넌트 적용

- AssumptionTestCard 적용
- EffectSizeCard 적용
- ConfidenceIntervalDisplay 적용
