...
- **통계 페이지**: 42개
  - **PyodideCore**: 40/42개 (95%) ✅ **목표 달성!**
  - **None**: 2/42개 (5%) - non-parametric, regression (향후 Phase)

**데이터 도구** (Phase 9 범위 외):
- **JavaScript**: 2개 (frequency-table, cross-tabulation) - /data-tools/ 이동 완료 ✅

**증가율**: 18개 (43%) → 40개 (95%) = **+22개 (+122%)**
...
| 항목 | 목표 | 현재 | 진행률 |
|------|------|------|--------|
| **PyodideCore 페이지** | 40개 | 40개 | 100% ✅ |
| **Batch 1 (pyodideStats)** | 10개 | 10개 | 100% ✅ |
| **Batch 2 (Legacy)** | 6개 | 6개 | 100% ✅ |
| **Batch 3 (JavaScript)** | 4개 | 4개 | 100% ✅ |
| **Batch 4 (None)** | 3개 | 3개 | 100% ✅ |
| **데이터 도구 분리** | 2개 | 2개 | 100% ✅ |
