...
- [ ] Bio-Tools worker/API 반환 shape fixture 계약 추가: `types/bio-tools-results.ts`, Python worker/API adapter 반환 키, `BioToolHistoryEntry.results`, document-writing type guard fixture가 같은 camelCase schema를 유지하는지 대표 fixture로 검증한다.
