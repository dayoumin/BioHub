...
export default function ChiSquareIndependencePage() {
  ...
  const breadcrumbs = useMemo(() => [
    ...
    { label: '카이제곱 독립성 검정', href: '/statistics/chi-square-independence' }
  ], [])
      ...
      {currentStep === 1 && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>두 범주형 변수 데이터를 업로드하세요</CardDescription>
          </CardHeader>
          <CardContent>
            <DataUploadStep
      ...
      {currentStep === 2 && uploadedData && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>독립성을 검정할 두 범주형 변수를 선택하세요</CardDescription>
          </CardHeader>
          <CardContent>
