...
export default {
  ...
  safelist: [
    // Semantic color utilities (used via CSS variables)
    "bg-highlight-bg",
    ...
    "text-info",
    "text-info-muted",
    // Dynamic category colors (statistical-tools-section.tsx, ui-config.ts)
    // Colors: blue, green, purple, orange, indigo, teal, rose
    "text-blue-600", "text-green-600", "text-purple-600", "text-orange-600",
    "text-indigo-600", "text-teal-600", "text-rose-600",
    "dark:text-blue-400", "dark:text-green-400", "dark:text-purple-400", "dark:text-orange-400",
    "dark:text-indigo-400", "dark:text-teal-400", "dark:text-rose-400",
    "bg-blue-50", "bg-green-50", "bg-purple-50", "bg-orange-50",
    "bg-indigo-50", "bg-teal-50", "bg-rose-50",
    "dark:bg-blue-950/30", "dark:bg-green-950/30", "dark:bg-purple-950/30", "dark:bg-orange-950/30",
    "dark:bg-indigo-950/30", "dark:bg-teal-950/30", "dark:bg-rose-950/30",
  ],
}
