...
**버전**: 1.2.0
**작성일**: 2026-02-04
**Pyodide 버전**: **v0.29.3 (2026년 1월)** - 최신 안정 버전
**목적**: Pyodide 환경에서 사용 가능한 통계 라이브러리 및 활용 가이드

> **중요**: 본 프로젝트는 **Pyodide v0.29.3**을 사용합니다. ([constants.ts:26](statistical-platform/lib/constants.ts#L26))
...
### Pyodide v0.29.3 포함 패키지 (2026년 1월) ✅ 현재 사용 중

| 패키지 | 버전 | 설명 | 프로젝트 사용 |
|--------|------|------|--------------|
| **NumPy** | **2.2.5** | 배열 연산, 기본 통계 | ✅ 핵심 |
| **SciPy** | **1.14.1** | 통계 검정, 확률 분포 | ✅ 핵심 |
| **Pandas** | **2.3.3** | 데이터 정제, 그룹화 | ✅ 핵심 |
...
**출처**: https://pyodide.org/en/0.29.3/usage/packages-in-pyodide.html

### 주요 업그레이드 (v0.24.1 → v0.29.3)

| 패키지 | v0.24.1 (구버전) | v0.29.3 (현재) | 변경사항 |
|--------|----------------|---------------|----------|
| NumPy | 1.26.0 | **2.2.5** | 메이저 업그레이드 (2.x) |
| SciPy | 1.11.2 | **1.14.1** | 마이너 업그레이드 |
| Pandas | 2.1.1 | **2.3.3** | 마이너 업그레이드 |
...
다음 라이브러리는 Pyodide v0.29.3에 포함되어 있지 않습니다:
...
### 공식 문서
- **Pyodide v0.29.3**: https://pyodide.org/en/0.29.3/
- **Pyodide 패키지 목록**: https://pyodide.org/en/0.29.3/usage/packages-in-pyodide.html
- **Pyodide API**: https://pyodide.org/en/0.29.3/usage/api/

### 라이브러리 문서 (v0.29.3 포함 버전)
- **NumPy 2.2.5**: https://numpy.org/doc/2.2/
- **SciPy 1.14.1**: https://docs.scipy.org/doc/scipy-1.14.1/
- **Pandas 2.3.3**: https://pandas.pydata.org/pandas-docs/version/2.3.3/
...
1. **Pyodide v0.29.3** 사용 중 ([constants.ts:26](statistical-platform/lib/constants.ts#L26))
2. **최신 과학 스택 포함**:
   - NumPy 2.2.5, SciPy 1.14.1, Pandas 2.3.3, statsmodels 0.14.4
...
**결론**: Pyodide v0.29.3은 브라우저에서 SPSS급 통계 분석을 가능하게 하는 강력한 플랫폼입니다.

---

**작성자**: Claude Code
**최종 수정**: 2026-02-04 (Pyodide v0.28.3 → v0.29.3 업그레이드)
