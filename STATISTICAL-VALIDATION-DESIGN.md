...
t-test, welch-t, one-sample-t, paired-t, anova, two-way-anova, mann-whitney, wilcoxon, kruskal-wallis, correlation, partial-correlation, regression, logistic-regression, stepwise, chi-square-independence, pca, cluster, kaplan-meier, cox-regression, roc-curve, normality-test, reliability, repeated-measures-anova

### e2e만 존재 (21개) — 외부 데이터 소싱 필요
